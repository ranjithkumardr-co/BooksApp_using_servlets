...
.rounded-3 {
  ...
  <body>
    <%ArrayList<Books> list4=new ArrayList<Books>();
list4=(ArrayList<Books>)request.getAttribute("SearchBookList");%>
   ...
   <header class=" p-3 bg-dark text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="DisplayBookServlet" class="d-flex align-items-center mb-2 mb-lg-0 text-black text-decoration-none">
...
<ul
        ...
        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" method="post" action="./searchBook">
          <input type="search" class="form-control form-control-dark" name ="searchByname" placeholder="Search..." aria-label="Search">
        </form>
...
<h1 class="pricing-card-title">Welcome <small class="text-muted fw-light">Anonymous</small></h1>
<%} else {%>
    ...
    <div class="col">
      <div class="card mb-4 rounded-3 shadow-sm float-end">
        ...
        <div class="card-body">
          ...
          <div class="card-body">
            <h5 class="card-title">No Book Found</h5>
            
          </div>
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Please Search</li>
            <li class="list-group-item">With Name Prefix</li>
      ...
      <div class="card mb-4 rounded-3 shadow-sm float-end">
        ...
        <div class="card-body">
         ...
         <div class="card-body">
							...
							<a href="AddToLike/<%= c.getBookid() %>"
								class="btn btn-danger w-30">Like</a> <a
								href="AddToReadLater/<%= c.getBookid() %>"
								class="btn btn-dark w-70">Read Later</a>
						</div>
        </div>
      </div>
    </div>
