...
.col {
	transition: 0.2s transform cubic-bezier(.155, 1.105, .295, 1.12), .3s
...
list1=(ArrayList<Books>)request.getAttribute("Books");%>
  ...
  <path
		...
		<h1 class="pricing-card-title">
			Welcome <small class="text-muted fw-light">Anonymous</small>
		</h1>
		<%} else {%>


		<h1 class="pricing-card-title">
			Welcome <small class="text-muted fw-light"><%=(String)session.getAttribute("name")%></small>
		</h1>
		<%} %>
